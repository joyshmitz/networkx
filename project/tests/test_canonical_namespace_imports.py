...
CANONICAL_MODULES = [
    ...
    "network_methodology_sandbox.intake.workspace_manifest",
    "network_methodology_sandbox.intake.workspace_snapshot",
    "network_methodology_sandbox.intake.workspace_validation",
