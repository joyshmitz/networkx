...
> `v1` close-out now lives in `project/docs/reviews/V1_CLOSEOUT_2026-04-03.md`.  
> Current operator guidance now lives in `project/docs/methodology/INTAKE_OPERATOR_GUIDE.md`.
