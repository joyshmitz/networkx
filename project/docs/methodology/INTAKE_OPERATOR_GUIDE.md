...
Якщо потрібна історія виконання `v1`, дивіться `docs/reviews/V1_CLOSEOUT_2026-04-03.md`. Якщо потрібна методологічна картина в цілому, дивіться `QUESTIONNAIRE_WORKFLOW.md` і `ROLE_MAP.md`.
